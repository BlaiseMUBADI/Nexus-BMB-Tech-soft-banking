...
class DepenseController extends Controller
{
    ...
    public function store(Request $request, OhadaAccountingService $accountingService)
    {
        ...
        // Sécurité : les Dépenses sont réservées aux guichets FIXE/CENTRAL, jamais aux MOBILE
        if ($guichet->type_guichet === 'MOBILE') {
            return response()->json(['success' => false, 'message' => "Les dépenses de caisse sont réservées aux guichets de bureau (FIXE). Un guichet MOBILE ne peut pas en saisir."], 403);
        }
