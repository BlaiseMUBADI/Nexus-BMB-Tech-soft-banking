        ...
        <div class="col-6 col-md-4">
            <div class="info-box shadow-sm">
                ...
                <div class="info-box-content">
                    <span class="info-box-text">Entrées aujourd'hui</span>
                    <span class="info-box-number">{{ number_format($stats['entrees_jour'], 2, ',', ' ') }}</span>
                </div>
            </div>
        </div>
        <div class="col-6 col-md-4">
            <div class="info-box shadow-sm">
                ...
                <div class="info-box-content">
                    <span class="info-box-text">Sorties aujourd'hui</span>
                    <span class="info-box-number">{{ number_format($stats['sorties_jour'], 2, ',', ' ') }}</span>
                </div>
            </div>
        </div>
        <div class="col-6 col-md-4">
            <div class="info-box shadow-sm">
                ...
                <div class="info-box-content">
                    <span class="info-box-text">Total mouvements</span>
                    <span class="info-box-number">{{ $stats['total_mouvements'] }}</span>
                </div>
            </div>
        </div>
    </div>
