		...
		<nav class="mt-2">
			<ul class="nav nav-pills nav-sidebar flex-column nav-child-indent" data-widget="treeview" role="menu">
                ...
                <li class="nav-item {{ request()->is('caisse*') ? 'menu-open' : '' }}">
                    ...
                    <ul class="nav nav-treeview custom-sub-menu">
                        <li class="nav-item">
							<a href="{{ route('caisses.ouverture') }}" class="nav-link sub-link {{ request()->is('caisses/ouverture*') ? 'active' : '' }}">
                                <i class="fas fa-key nav-icon"></i>
                                <p>Ouverture / Fermeture</p>
                            </a>
                        </li>
                        <li class="nav-item">
							<a href="#" class="nav-link sub-link {{ request()->is('caisse/operations*') ? 'active' : '' }}">
                                <i class="fas fa-exchange-alt nav-icon"></i>
                                <p>Opérations</p>
                            </a>
                        </li>
                        <li class="nav-item">
							<a href="#" class="nav-link sub-link {{ request()->is('caisse/transferts*') ? 'active' : '' }}">
                        ...
                        <li class="nav-item">
							<a href="#" class="nav-link sub-link {{ request()->is('caisse/comptabilite*') ? 'active' : '' }}">
